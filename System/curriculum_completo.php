...
<html class="html">
 <head>
  ...
  <link rel="stylesheet" type="text/css" href="css/curriculum_completo.css?59476794" id="pagesheet"/>
  <!-- Other scripts -->
  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    ...
    <div class="clearfix colelem" id="pu1041"><!-- group -->
     <div class="rounded-corners rgba-background grpelem" id="u1041"><!-- simple frame --></div>
     <div class="clearfix grpelem" id="pu1044"><!-- column -->
      <div class="colelem" id="u1044"><!-- simple frame --></div>
      <div class="colelem" id="u1045"><!-- simple frame --></div>
      <div class="colelem" id="u1046"><!-- simple frame --></div>
     </div>
     <img class="grpelem" id="u1042-24" src="images/u1042-24.png" alt="Dr. Alejandro González Merlo
Cirujano Dentista Endoperiodoncista Experiencia profesional Práctica Privada desde 1992. Cirujano dentista Egresado de la Universidad Nacional Autónoma de México U.N.A.M. Escuela Nacional de Estudios Profesionales Iztacala U.N.A.M. Posgrado en Endoperiodontología de la Universidad Nacional Autónoma de México U.N.A.M. Escuela Nacional de Estudios Profesionales Iztacala U.N.A.M. Clínica de Especialización de Endoperiodontología U.N.A.M. Dominio del Idioma Inglés en el Centro de Lenguas Extranjeeras (CENLE) U.N.A.M
" width="532" height="331"/><!-- rasterized frame -->
    </div>
    <div class="clearfix colelem" id="ppu1049"><!-- group -->
     <div class="clearfix grpelem" id="pu1049"><!-- column -->
      <div class="colelem" id="u1049"><!-- simple frame --></div>
      <div class="colelem" id="u1050"><!-- simple frame --></div>
      <div class="colelem" id="u1052"><!-- simple frame --></div>
      <div class="colelem" id="u1053"><!-- simple frame --></div>
      <div class="colelem" id="u1054"><!-- simple frame --></div>
      <div class="colelem" id="u1055"><!-- simple frame --></div>
      <div class="colelem" id="u1056"><!-- simple frame --></div>
      <div class="colelem" id="u1057"><!-- simple frame --></div>
      <div class="colelem" id="u1058"><!-- simple frame --></div>
     </div>
     <img class="grpelem" id="u1047-37" src="images/u1047-37.png" alt="Experiencia académica Profesor A nivel licenciatura en las asignaturas de Endodoncia, Periodoncia, Clínica Integral, Estomatología y Anestesia. Desde el año 2004 profesor del posgrado de Endodoncia del C.U.E.P.I. de la U.M.S.N.H. De las Asignaturas: Manejo del Dolor, Principios Básicos de Obturación, Microbiología Endodóntica, Inmunologia Pulpar, Biología Pulpar y Profesionalización de la Practica Endodóntica. Profesor del Curso Propedéutico para ingreso al C.U.E.P.I. Profesor titular del Diplomado en Periodontología y Endodoncia del Centro de Desarrollo Humano y Empresarial ELIGE Conferencista del Laboratorio SIEGFRIED RHEIN Conferencista Nacional Complementos profesionales
Asociaciones Profesionales Miembro del Consejo Mexicano de Endoperiodontología. Certificado número 000035 del Consejo de Endoperiodontología México D.F. enero 2004. Presidente de la Asociación de Ciencias Odontológicas de Michoacán
" width="727" height="425"/><!-- rasterized frame -->
    </div>
