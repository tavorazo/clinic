	...
	if($i!=14 && $i!=15){
		for($j=0;$j<4;$j++){
			echo "<td>".$i.":".$min."</td>";
				...
				$result2 = $conn->query("SELECT * FROM usuarios where rol='dentista'");
				//while ($row2 = mysql_fetch_row($result2, MYSQL_NUM))
				...
				if($contador_lunes> 20){
					echo "<td class='td_lleno'>";
				}
				else if($cotador_lunes > 3){
					echo "<td class='td_50'>";
				}
...
while ($fila_agenda = $agenda->fetch_row()){
	echo $fila_agenda[2]. ", ";
				...
				if($contador_martes> 20)
					echo "<td class='td_lleno'>";
				else if($cotador_martes > 3)
					echo "<td class='td_50'>";
				else
					echo "<td class='td_menor_50'>";
...
while ($fila_agenda = $agenda->fetch_row()){
	echo $fila_agenda[2]. ", ";
				...
				if($contador_viernes> 20)
					echo "<td class='td_lleno'>";
				else if($cotador_viernes > 3)
					echo "<td class='td_50'>";
				else
					echo "<td class='td_menor_50'>";
...
while ($fila_agenda = $agenda->fetch_row()){
	echo $fila_agenda[2]. ", ";
				...
				if($contador_sabado> 20)
					echo "<td class='td_lleno'>";
				else if($cotador_sabado > 3)
					echo "<td class='td_50'>";
				else
					echo "<td class='td_menor_50'>";
