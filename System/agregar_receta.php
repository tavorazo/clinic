...
<div class="wrapper">
  <?php
    $id_paciente = $_GET['id'];    
     echo " <a href='pacientes/ficha-paciente.php?id=",$id_paciente,"'> < Regresar </a>  | Agregar Receta<hr> <br><br>";

  ?>
  <form action="php/procesar_receta.php" method="POST">
    <label>Medicamento: </label>
    <textarea name="medicamento"  heigth="120px"></textarea><br>
