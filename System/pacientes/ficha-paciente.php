...
<?php
  ...
  echo " <div class='colelem' style='max-width:800px; width:700px'>";
      ...
      echo "<label style='display: block; width:150px; float:left'>Sexo: </label>", $row2[23],"<br>";
      echo "<label style='display: block; width:150px; float:left'>Referencia: </label>", $row2[16],"<br>";
      echo "</div></fieldset><br>";

      echo "<fieldset><legend>Direcci&oacute;n</legend><br><h2>";
      echo "<label style='display: block; width:200px; float:left'>Estado:  </label>", $row2[6],"<br>";
      echo "<label style='display: block; width:200px; float:left'>Ciudad:  </label>", $row2[7],"<br>";
      echo "<label style='display: block; width:200px; float:left'>Colonia:  </label>", $row2[8],"<br>";
      echo "<label style='display: block; width:200px; float:left'>Calle:  </label>", $row2[9],"<br>";
      echo "<label style='display: block; width:200px; float:left'>Numero:  </label>", $row2[10],"<br>";
      echo "<label style='display: block; width:200px; float:left'>C&oacute;digo Postal:  </label>", $row2[22], "<br>";
      echo "<label style='display: block; width:200px; float:left'>Tel&eacute;fono:  </label>", $row2[11],"<br>
