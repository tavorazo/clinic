   ...
   <div class="position_content" id="page_position_content">
    ...
    <div class="clearfix colelem" id="pu1132-5"><!-- group -->
     ...
     <div class="clearfix grpelem" id="u1134-4">
			...
			?>
      <a   href="lista_Noticias.php" style="float:left; margin-right:10px"> << Regresar </a> <h3  style="margin-right:5px">|</h3>
       <h1>Editar noticia</h1><hr><br>
			...
			<form action="procesar_editar.php" method="POST" enctype="multipart/form-data">
				...
				<textarea name="contenido" style="width:500px; height: 200px;"><?php echo $renglon['texto']?></textarea>
        <br><br>
				
				<label>Imagen actual</label><br>
				<input type="hidden" name="id" value="<?php echo $id; ?>">
				<img src="<?php echo $renglon['imagen'];  ?>" width="150px">
				<br>
				<input type="file" name="imagen" class="campoT"><br>
