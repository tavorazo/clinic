...
<head>
  ...
  <title>agregar_enfermedad</title>
...
<div class="clearfix colelem" id="pu1132-5"><!-- group -->
 ...
 <div class="clearfix grpelem" id="u1134-4">
   ...
   <div class="wrapper">
    <?php
    $id_paciente = $_GET['id'];
    echo " <a href='pacientes/ficha-paciente.php?id=",$id_paciente,"'> < Regresar </a>  | Registra enfermedad <hr> <br><br>";
    
    ?>
    <form action="php/procesar_enfermedad.php" method="POST">
      <label>Nombre de enfermedad: </label>
      <input type="text" name="nombre" class="campoTexto"><br>
