...
//$resul_usuario = $conn->query($select_usuario, $dbh) or die ("problema con la solicitud");
...
//$resul_vendedor = $conn->query($select_vendedor, $dbh) or die ("problema con la solicitud");
