    ...
    echo "<h3 style='margin-right:6px'> |</h3><h3> Editar </h3><br><hr><BR>";
     include("base.php");
      if($cat == '1'){
        ...
        echo "<img src='../pacientes/fotografias_clinicas/imagenes/",$renglon['nombre_foto'],"' width='100px'><br>";
      ...
      if($cat == '2'){
        ...
        echo "<img src='../pacientes/fotografias_externas/imagenes/",$renglon['nombre_foto'],"' width='100px'><br>";
