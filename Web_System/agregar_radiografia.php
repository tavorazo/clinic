...
<head>
  ...
  <title>agregar_radiografia</title>
 ...
 <div class="clearfix colelem" id="pu1132-5"><!-- group -->
   ...
   <div class="clearfix grpelem" id="u1134-4">
     ...
     <div class="wrapper">
      ...
      ?>
      Agregar Radiografia</h1><hr><br><br>
      <form action="pacientes/radiografias/procesar_radiografia.php" method="POST" enctype="multipart/form-data">
        <label>Imagen: </label>
        <input type="file" name="imagen"><br><br><br>
        <label>Descripcion: </label>
        <textarea name="descripcion"></textarea><br>
        <input type="hidden" value="<?php echo $id_paciente; ?>" name="id">
        <input type="submit" value="Cargar"><input type="reset" value="borrar">
      </form>
    </div>
  </div>
</div>
